 ...
 * @generated
 */
public class OGCServiceLocalServiceUtil {
    private static OGCServiceLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link de.i3mainz.flexgeo.portal.liferay.services.service.impl.OGCServiceLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static de.i3mainz.flexgeo.portal.liferay.services.model.OGCService addOGCService(
        ...
        return getService().addOGCService(ogcService);
    }
    ...
    */
    public static de.i3mainz.flexgeo.portal.liferay.services.model.OGCService createOGCService(
        long serviceId) {
        return getService().createOGCService(serviceId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static de.i3mainz.flexgeo.portal.liferay.services.model.OGCService deleteOGCService(
        long serviceId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteOGCService(serviceId);
    }
    ...
    */
    public static de.i3mainz.flexgeo.portal.liferay.services.model.OGCService deleteOGCService(
        de.i3mainz.flexgeo.portal.liferay.services.model.OGCService ogcService)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteOGCService(ogcService);
    }
    ...
    */
    public static de.i3mainz.flexgeo.portal.liferay.services.model.OGCService getOGCServiceByUuidAndGroupId(
        ...
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getOGCServiceByUuidAndGroupId(uuid, groupId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<de.i3mainz.flexgeo.portal.liferay.services.model.OGCService> getOGCServices(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getOGCServices(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getOGCServicesCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getOGCServicesCount();
    }
    ...
    */
    ...
    public static OGCServiceLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    OGCServiceLocalService.class.getName());

            if (invokableLocalService instanceof OGCServiceLocalService) {
                _service = (OGCServiceLocalService) invokableLocalService;
            } else {
                _service = new OGCServiceLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(OGCServiceLocalServiceUtil.class,
                "_service");
        }
