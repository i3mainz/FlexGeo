...
public class OGCServiceUtil {
     ...
     */
    public static OGCService update(OGCService ogcService, boolean merge)
        throws SystemException {
        return getPersistence().update(ogcService, merge);
    }
    ...
    public static OGCService update(OGCService ogcService, boolean merge,
        ...
        return getPersistence().update(ogcService, merge, serviceContext);
    }
    ...
    */
    ...
    public static de.i3mainz.flexgeo.portal.liferay.services.model.OGCService updateImpl(
        ...
        boolean merge)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().updateImpl(ogcService, merge);
    }
