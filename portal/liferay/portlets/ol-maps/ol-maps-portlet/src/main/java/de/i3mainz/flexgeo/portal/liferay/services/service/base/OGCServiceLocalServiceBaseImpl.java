...
/**
 * The base implementation of the o g c service local service.
 *
 * <p>
...
public abstract class OGCServiceLocalServiceBaseImpl
    ...
    public OGCService addOGCService(OGCService ogcService)
        ...
        return ogcServicePersistence.update(ogcService, false);
    }
    ...
    public OGCService updateOGCService(OGCService ogcService)
        throws SystemException {
        return updateOGCService(ogcService, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public OGCService updateOGCService(OGCService ogcService, boolean merge)
        throws SystemException {
        ogcService.setNew(false);

        return ogcServicePersistence.update(ogcService, merge);
    }
